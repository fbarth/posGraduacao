...
\makedendentitle{Faculdade de Tecnologia Bandeirantes -
  BandTec}{Análise Preditiva}{}

\section{Questões sobre clustering}
...
\item Faça uma análise de cluster utilizando o dataset sobre
  \textbf{abalos sísmicos} do site
  \footnote{http://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all\_month.csv}. Considere
  apenas as variáveis de \textbf{profundidade} e \textbf{magnitude}. 
\item Imprima a informação dos clusters em um mapa
...
Você identificou algum padrão que você considere relevante?
